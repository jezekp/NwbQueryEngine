...
public class HDFqlExample
{
	public static void test()
	{
		...
		HDFql.execute("USE FILE /tmp/ANM184389_20130207.nwb");
		...
		HDFql.execute("SELECT FROM lick_trace");
		HDFql.cursorFirst();
		System.out.println("Attribute value: " + HDFql.cursorGetChar());
		...
		HDFql.cursorFirst();
		while (HDFql.cursorNext() == HDFql.SUCCESS) {
			System.out.println("Like: " + HDFql.cursorGetChar() + " -- " + HDFql.cursorGetDatatype());
		}
